...
/*
# zone_editor/views/domain_selection.js              Copyright 2017 cPanel, Inc.
#                                                           All rights Reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
...
define(
    ...
    function(angular, _, LOCALE, DynamicTable) {
        ...
        var controller = app.controller(
            ...
            ["$q", "$location", "$routeParams", "growl", "Domains", "Zones", "$uibModal", "viewNavigationApi", "Features", "defaultInfo", "NVDataService",
            function($q, $location, $routeParams, growl, Domains, Zones, $uibModal, viewNavigationApi, Features, defaultInfo, NVDataService) {
                var list = this;
                ...
                list.selectPageSize = function() {
                    ...
                    if (defaultInfo.domains_per_page !== list.meta.pageSize) {
                        NVDataService.set({domains_per_page: list.meta.pageSize})
                        .then(function() {
...
/*
# manager/zone_editor/directives/dmarc_validators.js  Copyright(c) 2016 cPanel, Inc.
#                                                                     All rights Reserved.
# copyright@cpanel.net                                                   http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
...
/*
# manager/zone_editor/directives/caa_validators.js    Copyright(c) 2017 cPanel, Inc.
#                                                                     All rights Reserved.
# copyright@cpanel.net                                                   http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
...
/*
# zone_editor/views/manage.js                     Copyright(c) 2016 cPanel, Inc.
#                                                           All rights Reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/
...
define(
    ...
    function(angular, _, LOCALE, DynamicTable, DMARCRecord) {
        ...
        var controller = app.controller(
            ...
            ["$scope", "$routeParams", "growl", "Zones", "viewNavigationApi", "$uibModal", "Features", "defaultInfo", "NVDataService",
            function($scope, $routeParams, growl, Zones, viewNavigationApi, $uibModal, Features, defaultInfo, NVDataService) {
                var manage = this;
                ...
                manage.selectPageSize = function() {
                    ...
                    if (defaultInfo.zones_per_page !== table.meta.pageSize) {
                        NVDataService.set({zones_per_page: table.meta.pageSize})
                        .then(function() {
