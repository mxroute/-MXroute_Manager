 /*
# htaccess/leechprotect/leechprotect.js                  Copyright(c) 2015 cPanel, Inc.
#                                                           All rights Reserved.
# copyright@cpanel.net                                         http://cpanel.net
# This code is subject to the cPanel license. Unauthorized copying is prohibited
*/

/* global require: false, define: false, SetNvData: false*/
...
define(
    [
        ...
        $("#btnSettingsSave").click(function(){
            ...
            if(alwaysOpenDir === "1") {
                SetNvData("optionselect_leechprotect", dirSelectionOption + ":" + domain + ":" + alwaysOpenDir, nvdataCallback);
            } else {
