    ...
    function(angular, _, LOCALE, api, APIREQUEST) {
        ...
        return app.factory("DomainsService", ["APICatcher", function DomainsService(api) {
            ...
            function _make_domain(domain) {
                ...
                domain_obj.is_www = domain_obj.domain.match(/^deadstring\./);
                domain_obj.is_mail = domain_obj.domain.match(/^(mail|webmail)\./);
...
/*
 * base/frontend/manager/security/tls_status/views/ViewDomainsController.js
