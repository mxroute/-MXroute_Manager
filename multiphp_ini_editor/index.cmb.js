            ...
            function($scope, $location, configService, $routeParams, $timeout, spinnerAPI, alertService, growl, growlMessages) {
                ...
                $scope.informUser = function(){
                    if(!alreadyInformed){
                        ...
                        growl.info(LOCALE.maketext("You must click ‘[_1]’ to apply the new changes.", "Apply"),
                            {
                                ttl : -1 ,
                                onopen: function(){
                ...
                $scope.applyPhpSettings = function(){
                    ...
                    growlMessages.destroyAllMessages();
                    alreadyInformed = false;
                    if( typeof infoGrowlHandle !== "undefined" ) { infoGrowlHandle.destroy(); }
        ...
        var controller = app.controller(
            ...
            function($scope, $location, $routeParams, $timeout, spinnerAPI, alertService, growl, growlMessages, configService) {
                ...
                $scope.informUser = function(){
                    if(!alreadyInformed){
                        alreadyInformed = true;
                        growl.info(LOCALE.maketext("You must click ‘[_1]’ to apply the new changes.", "Save"),
                            {
                                ttl : -1 ,
                                onopen: function(){
                                    infoGrowlHandle = this;
